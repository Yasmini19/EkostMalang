...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
   ...
   <div class="container ">
     <a href="<?php echo site_url('/Laporanpdf_p') ?>" class="btn btn-info my-3 shadow p-3 mb-5 bg-white rounded" ><span class="glyphicon glyphicon-plus"><font color="black">Print Pdf</font></span></a>
   ...
   <table class="table" back>
    <thead class="thead-dark">
     ...
     <tbody style="background-color: white">
      <?php foreach ($p_list as $key => $value): ?>
       <tr>
          ...
          <td><img src="<?php echo base_url()?>./assets/upload/<?php echo $value->photo?>" alt="" width=100 height=100></td>
