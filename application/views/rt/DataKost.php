...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="https://s3.amazonaws.com/uifaces/faces/twitter/jsa/48.jpg" alt="User Image"><br>
        <div>
          <p class="app-sidebar__user-name">Hai, <?php echo $this->session->userdata('logged_in')['username']?></p>
        </div>
      </div>
        <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="<?php echo base_url('index.php/RT/DataKost')?>" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Data Kost</span><i class="treeview-indicator fa fa-angle-right"></i></a>
   ...
   <div class="container ">
     <a href="<?php echo site_url('/Laporanpdf_k') ?>" class="btn btn-info my-3 shadow p-3 mb-5 bg-white rounded" ><span class="glyphicon glyphicon-plus"><font color="black">Print Pdf</font></span></a>
