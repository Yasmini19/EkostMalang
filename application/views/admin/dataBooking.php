  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="app-menu__item active"><a class="app-menu__item" href="<?php echo base_url('index.php/DataBooking')?>" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Data Booking</span><i class="treeview-indicator fa fa-angle-right"></i></a>
              ...
              <table id="table_id" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $key->fk_id_user ?></td>
                    <td><?php echo $key->fk_id_kost ?></td>
