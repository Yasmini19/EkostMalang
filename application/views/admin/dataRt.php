  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="app-menu__item active"><a class="app-menu__item" href="<?php echo base_url('index.php/DataRt/')?>" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Data Rt</span><i class="treeview-indicator fa fa-angle-right"></i></a>
