  ...
  <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="<?php echo base_url('index.php/DataPenyewa')?>" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Data Penyewa</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        ...
        <li class="app-menu__item active"><a class="app-menu__item" href="<?php echo base_url('index.php/DataPemilik/')?>" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Data Pemilik</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          
        </li>

        <li class="treeview"><a class="app-menu__item" href="<?php echo base_url('index.php/DataBooking')?>" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Data Booking</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          
        </li>

        
        <li class="treeview"><a class="app-menu__item" href="<?php echo base_url('index.php/DataRt/')?>" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Data Rt</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          ...
          <div class="tile" >
            <center>
              ...
              <table id="table_id" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php foreach ($pemilik_list as $key) : ?>
                  <tr>
